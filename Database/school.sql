...
--
-- Host: localhost:3306
-- Generation Time: Nov 07, 2023 at 05:59 PM
...
CREATE TABLE `all_class_fees_table` (
  `all_class_fees_id` int NOT NULL,
  `class` varchar(20) NOT NULL,
  `year` int NOT NULL,
  `admission_fees` int NOT NULL,
  `session_fees` int DEFAULT NULL,
  `seminar_fee` int DEFAULT NULL,
  `event_fee` int DEFAULT NULL,
  `january_salary` int NOT NULL,
  `february_salary` int NOT NULL,
  `march_salary` int NOT NULL,
  `afril_salary` int NOT NULL,
  `first_terminal_exam_fees` int NOT NULL,
  `may_salary` int NOT NULL,
  `june_salary` int NOT NULL,
  `july_salary` int NOT NULL,
  `august_salary` int NOT NULL,
  `mid_terminal_exam_fees` int NOT NULL,
  `september_salary` int NOT NULL,
  `october_salary` int NOT NULL,
  `november_salary` int NOT NULL,
  `december_salary` int NOT NULL,
  `final_exam_fees` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `courses` (
  ...
  `course_seat` int NOT NULL,
  `course_start_date` date NOT NULL,
  `course_contact_person_name` varchar(50) NOT NULL,
  `course_contact_person_phone` int NOT NULL,
...
CREATE TABLE `examquestion` (
  ...
  `class` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `exam_marks` (
  ...
  `student_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `subject_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `class_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `session_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `exam_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `mark_obtained` int NOT NULL DEFAULT '0',
  `mark_total` int NOT NULL DEFAULT '100',
  `result` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'F',
  `point` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `feescollection` (
  ...
  `due_fees` int DEFAULT '0',
  `current_fees` int DEFAULT NULL,
...
CREATE TABLE `grade` (
  ...
  `name` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `grade_point` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `holiday` (
  ...
  `title` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `holiday` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `job_anounce` (
  ...
  `job_empty_post` tinyint NOT NULL,
...
CREATE TABLE `loan` (
  ...
  `staff_name` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `l_duration` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `mop` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `g_name` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `g_relationship` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `g_number` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `g_address` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `g_country` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `c_name` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `c_type` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `model` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `make` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `condition` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `date` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `news` (
  ...
  `news_title` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `date` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `news_content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `students` (
  ...
  `TotalFees` int UNSIGNED NOT NULL,
  `AdvanceFees` int NOT NULL,
...
CREATE TABLE `stuff` (
  ...
  `stuff_mobile` tinyint NOT NULL,
  `stuff_salary` tinyint NOT NULL,
...
CREATE TABLE `teachers` (
  ...
  `teachers_mobile` tinyint NOT NULL,
...
--
ALTER TABLE `all_class_fees_table`
  MODIFY `all_class_fees_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `alumni`
--
ALTER TABLE `alumni`
  MODIFY `a_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `apply_course`
--
ALTER TABLE `apply_course`
  MODIFY `apply_course_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `course_process_fees`
  MODIFY `course_fees_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `course_time_table`
--
ALTER TABLE `course_time_table`
  MODIFY `course_time_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `examquestion`
--
ALTER TABLE `examquestion`
  MODIFY `examquestion_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `exam_all_trash`
  MODIFY `trash_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `exam_marks`
--
ALTER TABLE `exam_marks`
  MODIFY `mark_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `seminar_registration`
  MODIFY `std_reg_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `students`
  MODIFY `std_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `student_registration`
--
ALTER TABLE `student_registration`
  MODIFY `std_reg_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `teachers`
  MODIFY `teachers_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
